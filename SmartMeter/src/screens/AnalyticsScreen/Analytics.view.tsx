...
//components
import { GilroyText, HeadlineText, SMIcons, Button } from 'library/components/atoms';
  ...
  const createFilterGroup = (item: ListRenderItemInfo<OptionsItem>) => {
    ...
    return (
      <View style={[styles.filterGroupContainer, item.index == 0 && {marginTop: 10}]}>
        ...
        <Text style={styles.filterGroupTitleText}>{curItem.title}</Text>
  ...
  return (
    <Host>
      <View style={styles.container}>
        <View style={styles.headContainer}>
          ...
          <View style={styles.profileInfoContainer}>
            <View style={styles.nameAdressTextContainer}>
              <Text style={styles.nameText}>Светлана Есаулкова</Text>
              <Text style={styles.addressText}>ул. Ленина 56</Text>
            </View>
          ...
          <View style={styles.filterContainer}>
            ...
            <View style={[styles.filterButtonContainer, {marginLeft: 5}]}>
              ...
              <TouchableOpacity style={styles.filterButton} onPress={onOptionsOpen}>
                ...
                <SMIcons name="ic_options" size={15} width={24} height={24} color="#000000" style={styles.filterIcon} />
        ...
        <Text style={styles.predictionText}>Прогноз на январь 1100 m³</Text>
